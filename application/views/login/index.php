                    ...
                    <div class="row w-100">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left p-5">
                                ...
                                <?php endif; ?>
                                <h2>Login</h2>
                                <h4 class="font-weight-light">Hello! Get ready for the ride today</h4>
                                ...
                                <div class="mt-5">
                                    <button type="submit" class="btn btn-block btn-lg font-weight-medium" style="color: #fff;background: linear-gradient(88deg, #FFC000, #FBD972);border-color: #03a9f3;">Login</button>
                                    <br>
                                    <span class="text-muted d-block text-center  justify-center ">Copyright © 2020 <a class="text-success" href="#">Smart Technology</a>. All rights reserved.</span>
                                </div>
                                <?= form_close(); ?>
                            </div>
                        </div>

            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <!--<input type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="currency" class="form-control" id="saldo" name="saldo" placeholder="enter Amount" value="" required>-->
                        <input type="text" class="form-control" id="saldo" name="saldo" placeholder="enter Amount" value="" required>
                    </div>
                    <div class="form-group">
                        <label for="keterangan">Keterangan</label>
                        <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Berikan keterangan topup" value="" required>
                    </div>

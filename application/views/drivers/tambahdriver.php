        ...
        <div class="col-md-8 offset-md-2 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="variantvehicle">Type Kendaraan</label>
                    ...
                    <div class="form-group">
                        <label for="vehicleregistration">Nomor Plat Kendaraan</label>
                    ...
                    <div class="form-group">
                        <label for="idcard">Massa Berlaku STNK</label>
                        <input type="date" class="form-control" id="masa_berlaku" name="masa_berlaku" <?php if ($_POST != NULL) { ?> value="<?= $_POST['tgl_lahir']; ?>" <?php } ?> placeholder="enter birth date " required>
                    </div>
                    <div>
                        <label>Foto STNK</label>
                        <input type="file" class="dropify" name="foto_stnk" data-max-file-size="3mb" required />
                    </div>
                    <br>

                    ...
                    <div class="wrapper">
                        ...
                        <div class="tab-content" id="myTabContent"> 
                            ...
                            <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                                 <?= form_open_multipart('area/addpricebasic'); ?> 
                                ...
                                <div class="row">
                                    <div class=" form-group col-4">
                                    <label class="text-small">Start KM</label>
                                    <input type="text" class="form-control" id="awal" name="awal" required value=<?= $awal??" "?>  >
                                </div>
                                </div>
                                <div class="row">
                                    <div class=" form-group col-4">
                                    <label class="text-small">End KM</label>
                                    <input type="text" class="form-control" id="akhir" name="akhir" required value=<?= $akhir??" "?>  >
                                </div>
                                </div>
                                <div class="row">
                                    <div class=" form-group col-4">

                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body avatar">
                            ...
                            <?= form_open_multipart('dashboard/fixwalletuser'); ?>
                            <div class="text-center text-primary">
                            <input type="hidden" class="form-control" id="iduser" name="iduser" value="<?= $user['id'] ?>">
                            <button type="submit" name="submit"value="fix" class="btn btn-success mr-2 ">Fix Wallet User</button>
                            </div>
                            <?= form_close(); ?>
